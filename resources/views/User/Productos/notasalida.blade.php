...
@section('title', 'Notas de Salida - Productos')
...
<div class="w-full grid grid-cols-3 items-center mb-3 mt-1 pl-3">
  ...
  <div>
    ...
    <p class="text-slate-500">Nota de Salida de Productos</p>
  </div>
  ...
  <div>
    <button 
      ...
      class="text-white bg-blue-700 hover:bg-blue-800 ml-64 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
      type="button">Agregar Material
    </button>
  </div>
</div>
      ...
      <tr>
        ...
        <td class="p-4">
          <div class="flex gap-4">
            <a href="{{ route('productos.notasalida.show', $nota->id) }}" class="text-blue-600 hover:text-blue-800" title="Ver Nota">
            ...
            <a href="{{ route('productos.notasalida.pdf', $nota->id) }}" class="text-red-600 hover:text-red-800" target="_blank" title="Exportar PDF">
