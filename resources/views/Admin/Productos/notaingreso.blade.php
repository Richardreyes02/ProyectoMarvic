      ...
      <tr class="hover:bg-gray-100">
        ...
        <td class="p-4">
          <div class="flex gap-4">
            <a href="{{ route('productos.notaingreso.show', $nota->id) }}" title="Ver Nota">
            ...
            <a href="{{ route('productos.notaingreso.pdf', $nota->id) }}" target="_blank" title="Exportar PDF">
              <svg class="w-5 h-5 text-red-500 hover:text-red-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
