...
<body>
  ...
  <div class="title">NOTA DE INGRESO DE MATERIALES</div>
  ...
  <table class="info-box">
    ...
    <tr>
      <td><strong>Proveedor:</strong> {{ $nota->proveedor->razon_social }}</td>
    </tr>
    <tr>
    ...
    <tbody>
      ...
      @foreach ($nota->detalles as $detalle)
        ...
        <tr>
          ...
          <td class="right">{{ $detalle->unidad_medida }}</td>
          <td>{{ $detalle->material->nombre }}</td>
          <td class="right">S/ {{ number_format($detalle->costo_unitario, 2) }}</td>
  ...
  <table class="total-box">
    <tr>
      <td class="right"><strong>Total:</strong> S/ {{ number_format($total, 2) }}</td>
    </tr>
  </table>
